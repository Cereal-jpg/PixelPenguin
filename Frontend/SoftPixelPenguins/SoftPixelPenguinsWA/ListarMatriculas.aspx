<%@ Page Title="" Language="C#" MasterPageFile="~/SoftPixelPenguins.Master" AutoEventWireup="true" CodeBehind="ListarMatriculas.aspx.cs" Inherits="SoftPixelPenguinsWA.ListarMatriculas" %>
            ...
            <div class="card-body">
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-12 col-md text-md-end mt-3 mt-md-0">
                        <asp:LinkButton ID="lbRegistrar" runat="server" CssClass="btn btn-success" Text="<i class='fa-solid fa-plus'></i> Registrar Matricula" OnClick="lbRegistrar_Click"/>
                    </div>
                </div>
                <div class="row">
                    <asp:GridView ID="gvMatriculas" runat="server" AllowPaging="true" PageSize="5" AutoGenerateColumns="false" CssClass="table table-hover table-responsive table-striped" ShowHeaderWhenEmpty="true">
                        <Columns>
