                ...
                <div class="col-md-12">
                    ...
                    <div class="form-control d-flex justify-content-center">
                        <div class="form-check form-check-inline m-auto">
                            <asp:RadioButton ID="rbNotas" runat="server" CssClass="form-check-input" GroupName="reporte" Text="Notas por Grado Académico" />
                        </div>
                        <div class="form-check form-check-inline m-auto">
                            <asp:RadioButton ID="rbMatriculas" runat="server" CssClass="form-check-input" GroupName="reporte" Text="Matrículas por Grado" />
                        </div>
                        <div class="form-check form-check-inline m-auto">
                            <asp:RadioButton ID="rbPensiones" runat="server" CssClass="form-check-input" GroupName="reporte" Text="Pensiones por Grado" />
                        </div>
                    </div>
                </div>
             </div>
