...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContenido" runat="server">
    ...
    <h2 style="color: black;">Gestionar Usuarios</h2>
        <div class="container-matricula" style="display: block;">
            ...
            <div class="row">
                <div class="col-12">
                    <asp:GridView ID="gvUsuarios" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered" Style="background-color: transparent;" PageSize="10" AllowPaging="True" OnPageIndexChanging="gvUsuarios_PageIndexChanging">
                        <Columns>
