...
DROP PROCEDURE IF EXISTS INSERTAR_ANIOACADEMICO;
DROP PROCEDURE IF EXISTS MODIFICAR_ANIOACADEMICO;
DROP PROCEDURE IF EXISTS ELIMINAR_ANIOACADEMICO;
DROP PROCEDURE IF EXISTS LISTAR_TODOS_ANIOACADEMICO;
DROP PROCEDURE IF EXISTS OBTENER_POR_ID_ANIOACADEMICO;
...
BEGIN
    ...
    VALUES (p_anio,p_fechaInicio,p_fechaFin,1);
