...
import pe.edu.pucp.pixelpenguins.db.Tipo_Operacion;
...
public class AdministradorDAOImpl extends DAOImpl implements AdministradorDAO {
    ...
    protected String obtenerListaDeAtributosParaInsercion() {
        return "idAdministrador, codigoAdministrador";
    }
    ...
    protected String generarSQLParaListarTodos(Integer limite) {
        ...
        sql = sql.concat("join Usuario usu on usu.idUsuario = a.idAdministrador ");
    ...
    public Boolean existeAdministrador(Administrador administrador, Boolean abreConexion) {
        ...
        try {
            ...
            String sql = "select idUsuario from Administrador where idAdministrador=?";
            this.colocarSQLenStatement(sql);
            this.incluirParametroInt(1, administrador.getIdUsuario());
            this.ejecutarConsultaEnBD(sql);

            if (this.resultSet.next()) {
                idUsuario = this.resultSet.getInt("idAdministrador");
            }
        } catch (SQLException ex) {
